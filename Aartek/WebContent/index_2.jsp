...
<div id="header">
	...
	<div id="menu">
		<ul>
			...
			<li><a href="#" accesskey="2" title="">register_candidate</a></li>
			<li><a href="#" accesskey="3" title="">Shedule_candidate</a></li>
			<li><a href="#" accesskey="4" title="">interview_responce</a></li>
			<li><a href="#" accesskey="5" title="">process_candidate</a></li>
			<li><a href="#" accesskey="5" title="">current_hired</a></li>
...
<div id="page">
	...
	khghghdgsjghjgjhdsghjhjgj<br>
		dsgsdagddddddddddddddddddddddddddddd<br>
