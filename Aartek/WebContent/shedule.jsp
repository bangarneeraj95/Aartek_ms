...
<div id="header">
	...
	<div id="menu">
		<ul>
			...
			<li class="active"><a href="#" accesskey="3" title="">Shedule_candidate</a></li>
...
<th>Date</th><th>Time</th><th><input type="submit" value="shedule"></th><th>Reshedule</th>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"> <tr>    <td>      <div>      </br></br>
  <a href="http://localhost:7070/Aartek/DownloadServlet?filename=<%=dto1.getResume_path() %> style="background-color:#EB7035;border:1px solid #EB7035;border-radius:3px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:16px;line-height:6px;text-align:center;text-decoration:none;width:100px;-webkit-text-size-adjust:none;mso-hide:all;">View Resume &rarr;</a> </div></td></tr></table>
  </td>
...
<td><%= dto1.getDate() %></td>
<td><%=dto1.getTime() %></td><td> &nbsp;&nbsp; <input type="checkbox" name="shedule" value="<%=dto1.getId()%>" ></td>
<td> <div> <a href='http://localhost:7070/Aartek/candi_reshedule.jsp?uname=<%=dto1.getId()%> '>Reshedule</a> </div> </td>
</tr>
